...
const SEED_RECIPES = [
  ...
  {
    titre: "Feijoada express",
    photo: "/recipes/feijoada-express.jpg",
    temps_preparation: 60, difficulte: "moyen", prix_estime: 8,
    description: "Ragoût de haricots noirs et viandes fumées, plat brésilien réconfortant.",
    calories: 580, proteines: 32, lipides: 28,
    tags: ["brésilien", "copieux", "hiver"],
    etapes: ["Faire revenir oignon et ail dans l'huile.", "Ajouter la poitrine et la saucisse fumées, faire dorer.", "Ajouter les haricots noirs et le laurier, couvrir d'eau et mijoter 40 min."],
    ingredients: [{ nom: "haricots noirs cuits", quantite: 400, unite: "g" }, { nom: "poitrine fumée", quantite: 150, unite: "g" }, { nom: "saucisse fumée", quantite: 150, unite: "g" }, { nom: "oignon", quantite: 1, unite: "pièce" }, { nom: "ail", quantite: 2, unite: "pièce" }, { nom: "laurier", quantite: 1, unite: "feuille" }],
  },
  {
    titre: "Moqueca de poisson",
    photo: "/recipes/moqueca-poisson.jpg",
    temps_preparation: 35, difficulte: "moyen", prix_estime: 9,
    description: "Ragoût de poisson au lait de coco, poivrons et coriandre.",
    calories: 380, proteines: 30, lipides: 18,
    tags: ["brésilien", "sans gluten"],
    etapes: ["Faire revenir oignon, poivrons et tomates.", "Ajouter le lait de coco, laisser mijoter 5 min.", "Ajouter le poisson, cuire 10 min à couvert.", "Parsemer de coriandre fraîche."],
    ingredients: [{ nom: "filet de poisson blanc", quantite: 500, unite: "g" }, { nom: "lait de coco", quantite: 400, unite: "ml" }, { nom: "poivron", quantite: 2, unite: "pièce" }, { nom: "oignon", quantite: 1, unite: "pièce" }, { nom: "tomate", quantite: 2, unite: "pièce" }, { nom: "coriandre fraîche", quantite: 1, unite: "bouquet" }],
  },
  {
    titre: "Brigadeiro",
    photo: "/recipes/brigadeiro.jpg",
    temps_preparation: 20, difficulte: "facile", prix_estime: 3,
    description: "Petites bouchées fondantes au chocolat, spécialité brésilienne.",
    calories: 290, proteines: 4, lipides: 12,
    tags: ["brésilien", "sucré", "économique"],
    etapes: ["Mélanger lait concentré, cacao et beurre dans une casserole.", "Cuire à feu doux en remuant 10 min jusqu'à épaississement.", "Laisser refroidir, former des boules, rouler dans les vermicelles en chocolat."],
    ingredients: [{ nom: "lait concentré sucré", quantite: 395, unite: "g" }, { nom: "cacao en poudre", quantite: 3, unite: "cuillère à soupe" }, { nom: "beurre", quantite: 15, unite: "g" }, { nom: "vermicelles en chocolat", quantite: 50, unite: "g" }],
  },
  {
    titre: "Enchiladas au poulet",
    photo: "/recipes/enchiladas-poulet.jpg",
    temps_preparation: 40, difficulte: "moyen", prix_estime: 8,
    description: "Tortillas garnies de poulet, roulées et gratinées sous une sauce épicée.",
    calories: 520, proteines: 30, lipides: 22,
    tags: ["mexicain", "copieux"],
    etapes: ["Mélanger le poulet émietté avec l'oignon et le cumin.", "Garnir les tortillas, rouler et disposer dans un plat.", "Napper de sauce tomate et de fromage râpé.", "Enfourner 20 min à 200°C."],
    ingredients: [{ nom: "tortilla de maïs", quantite: 8, unite: "pièce" }, { nom: "poulet cuit émietté", quantite: 300, unite: "g" }, { nom: "sauce tomate épicée", quantite: 400, unite: "g" }, { nom: "fromage râpé", quantite: 150, unite: "g" }, { nom: "oignon", quantite: 1, unite: "pièce" }, { nom: "cumin", quantite: 1, unite: "cuillère à café" }],
  },
  {
    titre: "Guacamole et totopos",
    photo: "/recipes/guacamole-totopos.jpg",
    temps_preparation: 15, difficulte: "facile", prix_estime: 5,
    description: "Avocat écrasé, citron vert et coriandre, à partager avec des chips de maïs.",
    calories: 320, proteines: 6, lipides: 24,
    tags: ["mexicain", "rapide", "végan", "sans gluten"],
    etapes: ["Écraser les avocats à la fourchette.", "Ajouter citron vert, oignon et tomate en dés, coriandre.", "Assaisonner et servir avec les totopos."],
    ingredients: [{ nom: "avocat", quantite: 3, unite: "pièce" }, { nom: "citron vert", quantite: 1, unite: "pièce" }, { nom: "oignon rouge", quantite: 0.5, unite: "pièce" }, { nom: "tomate", quantite: 1, unite: "pièce" }, { nom: "coriandre fraîche", quantite: 1, unite: "bouquet" }, { nom: "chips de maïs", quantite: 150, unite: "g" }],
  },
  {
    titre: "Fajitas au bœuf",
    photo: "/recipes/fajitas-boeuf.jpg",
    temps_preparation: 30, difficulte: "moyen", prix_estime: 9,
    description: "Lanières de bœuf épicées, poivrons et oignons, tortillas chaudes.",
    calories: 480, proteines: 32, lipides: 20,
    tags: ["mexicain", "épicé", "riche en protéines"],
    etapes: ["Émincer bœuf, poivrons et oignon.", "Faire revenir la viande avec les épices à feu vif.", "Ajouter poivrons et oignon, cuire 5 min.", "Servir avec les tortillas chaudes."],
    ingredients: [{ nom: "aiguillette de bœuf", quantite: 400, unite: "g" }, { nom: "poivron", quantite: 2, unite: "pièce" }, { nom: "oignon", quantite: 1, unite: "pièce" }, { nom: "tortilla de blé", quantite: 8, unite: "pièce" }, { nom: "épices fajitas", quantite: 1, unite: "cuillère à soupe" }, { nom: "huile d'olive", quantite: 1, unite: "cuillère à soupe" }],
  },
  {
    titre: "Chana masala",
    photo: "/recipes/chana-masala.jpg",
    temps_preparation: 30, difficulte: "facile", prix_estime: 4,
    description: "Pois chiches mijotés dans une sauce tomate épicée aux épices indiennes.",
    calories: 340, proteines: 14, lipides: 10,
    tags: ["indien", "végan", "épicé", "économique"],
    etapes: ["Faire revenir oignon, ail et gingembre.", "Ajouter le garam masala puis les tomates, laisser réduire 5 min.", "Ajouter les pois chiches, mijoter 15 min."],
    ingredients: [{ nom: "pois chiches cuits", quantite: 400, unite: "g" }, { nom: "tomates concassées", quantite: 400, unite: "g" }, { nom: "oignon", quantite: 1, unite: "pièce" }, { nom: "ail", quantite: 2, unite: "pièce" }, { nom: "gingembre", quantite: 1, unite: "cuillère à café" }, { nom: "garam masala", quantite: 1, unite: "cuillère à soupe" }],
  },
  {
    titre: "Palak paneer",
    photo: "/recipes/palak-paneer.jpg",
    temps_preparation: 35, difficulte: "moyen", prix_estime: 7,
    description: "Purée d'épinards crémeuse et dés de fromage paneer.",
    calories: 420, proteines: 18, lipides: 28,
    tags: ["indien", "végétarien", "sans gluten"],
    etapes: ["Mixer les épinards blanchis en purée.", "Faire revenir oignon, ail et épices.", "Ajouter la purée d'épinards et la crème, mijoter 10 min.", "Ajouter le paneer coupé en dés, réchauffer 5 min."],
    ingredients: [{ nom: "épinards frais", quantite: 500, unite: "g" }, { nom: "paneer", quantite: 250, unite: "g" }, { nom: "crème fraîche", quantite: 10, unite: "cl" }, { nom: "oignon", quantite: 1, unite: "pièce" }, { nom: "ail", quantite: 2, unite: "pièce" }, { nom: "garam masala", quantite: 1, unite: "cuillère à café" }],
  },
  {
    titre: "Biryani au poulet",
    photo: "/recipes/biryani-poulet.jpg",
    temps_preparation: 50, difficulte: "moyen", prix_estime: 9,
    description: "Riz basmati parfumé, poulet mariné et oignons croustillants.",
    calories: 560, proteines: 34, lipides: 20,
    tags: ["indien", "copieux", "épicé"],
    etapes: ["Mariner le poulet dans le yaourt et les épices 20 min.", "Faire revenir les oignons émincés jusqu'à ce qu'ils soient dorés, en réserver la moitié.", "Cuire le poulet mariné 10 min.", "Ajouter le riz et le bouillon, cuire à couvert 18 min.", "Parsemer des oignons croustillants avant de servir."],
    ingredients: [{ nom: "riz basmati", quantite: 300, unite: "g" }, { nom: "poulet", quantite: 400, unite: "g" }, { nom: "yaourt nature", quantite: 100, unite: "g" }, { nom: "oignon", quantite: 2, unite: "pièce" }, { nom: "épices biryani", quantite: 1, unite: "cuillère à soupe" }, { nom: "bouillon", quantite: 300, unite: "ml" }],
  },
  {
    titre: "Dal de lentilles corail",
    photo: "/recipes/dal-lentilles-corail.jpg",
    temps_preparation: 25, difficulte: "facile", prix_estime: 3,
    description: "Lentilles corail fondantes mijotées au lait de coco et épices.",
    calories: 310, proteines: 16, lipides: 8,
    tags: ["indien", "végan", "économique", "sans gluten"],
    etapes: ["Faire revenir oignon, ail et épices.", "Ajouter les lentilles rincées et l'eau, cuire 15 min.", "Ajouter le lait de coco, mijoter 5 min."],
    ingredients: [{ nom: "lentilles corail", quantite: 250, unite: "g" }, { nom: "lait de coco", quantite: 200, unite: "ml" }, { nom: "oignon", quantite: 1, unite: "pièce" }, { nom: "ail", quantite: 2, unite: "pièce" }, { nom: "curcuma", quantite: 1, unite: "cuillère à café" }, { nom: "cumin", quantite: 1, unite: "cuillère à café" }],
  },
  {
    titre: "Ramen au porc",
    photo: "/recipes/ramen-porc.jpg",
    temps_preparation: 40, difficulte: "moyen", prix_estime: 8,
    description: "Nouilles, bouillon dashi, porc mijoté et œuf mollet.",
    calories: 620, proteines: 30, lipides: 24,
    tags: ["japonais", "copieux"],
    etapes: ["Faire mijoter le porc dans le bouillon avec la sauce soja 25 min.", "Cuire les nouilles ramen.", "Répartir nouilles et bouillon dans les bols, ajouter le porc tranché, l'œuf mollet et l'oignon nouveau."],
    ingredients: [{ nom: "nouilles ramen", quantite: 300, unite: "g" }, { nom: "poitrine de porc", quantite: 300, unite: "g" }, { nom: "bouillon dashi", quantite: 1, unite: "l" }, { nom: "œuf", quantite: 2, unite: "pièce" }, { nom: "oignon nouveau", quantite: 2, unite: "pièce" }, { nom: "sauce soja", quantite: 2, unite: "cuillère à soupe" }],
  },
  {
    titre: "Saumon teriyaki",
    photo: "/recipes/saumon-teriyaki.jpg",
    temps_preparation: 20, difficulte: "facile", prix_estime: 9,
    description: "Pavés de saumon laqués à la sauce teriyaki, riz vapeur.",
    calories: 440, proteines: 32, lipides: 22,
    tags: ["japonais", "riche en protéines", "rapide"],
    etapes: ["Mélanger sauce soja, mirin et sucre.", "Saisir le saumon 3 min de chaque côté.", "Ajouter la sauce, laisser réduire 2 min en nappant le poisson.", "Servir avec le riz."],
    ingredients: [{ nom: "pavé de saumon", quantite: 4, unite: "pièce" }, { nom: "sauce soja", quantite: 3, unite: "cuillère à soupe" }, { nom: "mirin", quantite: 2, unite: "cuillère à soupe" }, { nom: "sucre", quantite: 1, unite: "cuillère à soupe" }, { nom: "riz cuit", quantite: 300, unite: "g" }],
  },
  {
    titre: "Onigiri",
    photo: "/recipes/onigiri.jpg",
    temps_preparation: 20, difficulte: "facile", prix_estime: 3,
    description: "Boulettes de riz vinaigré garnies, enveloppées d'une bande de nori.",
    calories: 220, proteines: 5, lipides: 2,
    tags: ["japonais", "rapide", "végétarien", "économique"],
    etapes: ["Cuire le riz et l'assaisonner de vinaigre de riz.", "Former des boules avec un creux au centre.", "Garnir puis refermer le riz autour.", "Envelopper d'une bande de nori."],
    ingredients: [{ nom: "riz à sushi", quantite: 300, unite: "g" }, { nom: "algue nori", quantite: 4, unite: "feuille" }, { nom: "thon mayo", quantite: 4, unite: "cuillère à soupe" }, { nom: "vinaigre de riz", quantite: 1, unite: "cuillère à soupe" }],
  },
  {
    titre: "Udon sauté aux légumes",
    photo: "/recipes/udon-legumes.jpg",
    temps_preparation: 20, difficulte: "facile", prix_estime: 5,
    description: "Nouilles udon sautées au wok avec légumes croquants et sauce soja.",
    calories: 380, proteines: 12, lipides: 10,
    tags: ["japonais", "végétarien", "rapide"],
    etapes: ["Faire sauter les légumes émincés dans l'huile de sésame.", "Ajouter les nouilles udon cuites.", "Napper de sauce soja, mélanger 3 min à feu vif."],
    ingredients: [{ nom: "nouilles udon", quantite: 300, unite: "g" }, { nom: "carotte", quantite: 1, unite: "pièce" }, { nom: "chou", quantite: 200, unite: "g" }, { nom: "poivron", quantite: 1, unite: "pièce" }, { nom: "sauce soja", quantite: 2, unite: "cuillère à soupe" }, { nom: "huile de sésame", quantite: 1, unite: "cuillère à soupe" }],
  },
  {
    titre: "Bruschetta tomate-basilic",
    photo: "/recipes/bruschetta-tomate-basilic.jpg",
    temps_preparation: 15, difficulte: "facile", prix_estime: 4,
    description: "Pain grillé, tomates fraîches, basilic et huile d'olive.",
    calories: 260, proteines: 6, lipides: 10,
    tags: ["italien", "rapide", "végétarien", "été"],
    etapes: ["Griller les tranches de pain et les frotter d'ail.", "Couper les tomates en dés, mélanger avec le basilic ciselé et l'huile d'olive.", "Répartir sur le pain grillé."],
    ingredients: [{ nom: "pain de campagne", quantite: 8, unite: "tranche" }, { nom: "tomate", quantite: 4, unite: "pièce" }, { nom: "basilic frais", quantite: 1, unite: "bouquet" }, { nom: "ail", quantite: 1, unite: "pièce" }, { nom: "huile d'olive", quantite: 3, unite: "cuillère à soupe" }],
  },
  {
    titre: "Panna cotta",
    photo: "/recipes/panna-cotta.jpg",
    temps_preparation: 15, difficulte: "facile", prix_estime: 4,
    description: "Crème vanillée onctueuse, coulis de fruits rouges.",
    calories: 320, proteines: 5, lipides: 22,
    tags: ["italien", "sucré"],
    etapes: ["Faire chauffer la crème, le sucre et la vanille sans bouillir.", "Hors du feu, ajouter la gélatine essorée et mélanger.", "Répartir dans des verrines, réfrigérer 4h.", "Napper de coulis de fruits rouges avant de servir."],
    ingredients: [{ nom: "crème liquide entière", quantite: 50, unite: "cl" }, { nom: "sucre", quantite: 60, unite: "g" }, { nom: "gélatine", quantite: 3, unite: "feuille" }, { nom: "vanille", quantite: 1, unite: "gousse" }, { nom: "coulis de fruits rouges", quantite: 100, unite: "g" }],
  },
];
